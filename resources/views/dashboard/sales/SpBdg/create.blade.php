...
<div class="box-body">
  <form method="post" action="/dashboard/sales/SpBdg" class="mb-5">
      @csrf
          <div class="row">
        ...
        <table class="table teble-responsive table-bordered" id="dynamicAddRemove">
            ...
            <div class="row">
              <div class="col-lg-12">
                <a href="/dashboard/sales/SpBdg" class="btn btn-warning btn-md">Cancel</a>
...
<script type="text/javascript">
    $(document).on('change', '#product_name', function(){
        ...
        $.ajax({
            url : '/dashboard/sales/SpBdg/' +$(this).val(),
            type : 'post',
            data : {
