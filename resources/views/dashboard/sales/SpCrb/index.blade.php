...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <div>
        {{-- <a href="/dashboard/details/SpCrb" class="btn btn-warning btn-sm mb-3">Dashboard</a> --}}
        <a href="/dashboard/sales/SpCrb/create" class="btn btn-primary btn-sm mb-3">New Sales Report</a>
    </div>
...
<div class="col-lg-6 panel panel-heading mb-3">
    <form action="/dashboard/sales/SpCrb" method="GET">
        @csrf
                ...
                @foreach ($sales as $sale)
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="/dashboard/sales/SpCrb/{{ $sale->id }}" method="post" class="d-inline">
                                @method('DELETE')
                                    @csrf
