...
class DashboardSalesSpCrbController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        { 
            ...
            $sales = Sale::whereBetween('invoice_date', [request('fromDate'), request('toDate')])
                    ->where('branch_name', 'Saripetojo Cirebon')
        ...
        return view('dashboard.sales.SpCrb.index', compact('sales'))
    ...
    public function create()
    {
        ...
        return view('dashboard.sales.SpCrb.create', [                                     
            'invoice_number' => $code,
            'sales' => Sale::all(),
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/sales/SpCrb')->with('success', 'New sales transaction has been added!');
    }
    ...
    {
        return view('dashboard.sales.SpCrb.edit', [                                     
            'sale' => $sale,
            'products' => product::all(),
            'branches' => Branch::all(),
        ]);
    ...
    {
        dd($sale);
        Sale::findOrFail($sale->id)->destroy();
    
        return redirect('/dashboard/sales/SpCrb')->with('success', 'One sales data has been deleted!');
    }
